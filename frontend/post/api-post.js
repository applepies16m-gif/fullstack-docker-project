const create = (params, credentials, post) => {
  return fetch('/api/message', {       // <-- point to backend route
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json', // must stringify JSON
      //'Authorization': 'Bearer ' + credentials.t  <-- remove for now
    },
    body: JSON.stringify({ text: post })  // backend expects { text: "..." }
  })
  .then((response) => {
